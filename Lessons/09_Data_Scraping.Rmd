...
df_withdrawals <- df_withdrawals %>% 
  mutate(Registrant = !!the_registrant,  #!! shows it is a variable
...
the_year <- 2015
the_scrape_url <- paste0(the_base_url, '/', the_facility, '/', the_year) #paste0 eliminates spaces in string
...
the_dfs <- map(the_years,the_facility=my_facility, scrape.it)
