...
EPAair.subsample <- sample_n(EPAair, 5000) #takes random sample of data
...
```{r}
#Exercise 2:
density <- ggplot(EPAair, aes(x=Ozone, fill = as.factor(Year))) +
...
lregression <- lm(Data = EPAair, PM2.5 ~ Ozone) 
summary(lregression)
