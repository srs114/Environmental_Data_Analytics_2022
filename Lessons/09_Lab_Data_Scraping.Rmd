...
gage_data <- read.table(theURL,skip = 28,header=TRUE,sep='\t') #"skip" skipped commendted rows
...
#Get the data, which starts on line 30
gage_data <- read.table(theURL2,skip = 28,header=TRUE,sep='\t') #"skip" skipped commendted rows
...
the_df <- data.frame("State" = the_states,
"Price" = as.numeric(the_price), "Capacity" = as.numeric(gsub(",","",the_capacity)) 
