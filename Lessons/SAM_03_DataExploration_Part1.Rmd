...
write.csv(USGS.flow.data, file = "../Data/Processed/USGS.csv", row.names=FALSE)
...
Actually works
```{r}
write.csv(USGS.flow.data, file = "../Environmental_Data_Analytics_2022/Data/Processed/USGS_Site02085000_Flow_Processed.csv", row.names=FALSE)
```
